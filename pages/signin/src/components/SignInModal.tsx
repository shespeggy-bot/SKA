...
const img1 = asset("86da98be8130ff6f5a1153ba046a615d521b6cd2.png");
const img2 = asset("c619052252f66444ea32021c63ff9eaf5cad9c0a.png");
const img5 = asset("fda2c034cb113ef89a2cb5735458069f36af84e5.png");
const img3 = asset("bc26fde5cfa50cf1c61d03a1dd04c25f42632624.png");
const imgLihe = asset("e9f2f6493eca919a04902a533539c43bdc1c924f.png");
const img8 = asset("3fc4de2a3c40e626110400646014b381aaef2834.png");
const img9 = asset("70e16851aabd0ec3c31c7bc9c71f5505720c4297.png");
const img4 = asset("7afc9eb640bf27e0c5ebdfa06be7491c00cba1d5.svg");
const img6 = asset("c88244b022003a4dfc913114fa47a3fb9d008b39.svg");
const img7 = asset("20c4121af816b02fa46ce026413e95b6d005c3a9.svg");
const img424 = asset("b6b08b9c98a2b7515f3547e961ee44cb4dbc4972.svg");

/** 签到 (Figma node 0:1084) */
export function SignInModal() {
  return (
    <div className="relative size-full bg-[#757575]" data-name="签到">
      ...
      <div
        ...
        data-name="矩形 3132"
      />
      <div className="absolute contents left-[-59px] top-[450px]" data-name="光">
        <div
        ...
        <div className="absolute left-[26px] top-[539px] h-[702px] w-[606px]" data-name="底光">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-[calc(50%+249.5px)] top-[1006px] size-[43px] -translate-x-1/2" data-name="星形 4">
          <div className="absolute inset-[-4.65%]">
            <img alt="" className="block size-full max-w-none" src={img4} />
          </div>
        </div>
        ...
        <div className="absolute left-[calc(50%-270px)] top-[769px] size-[46px] -translate-x-1/2" data-name="星形 6">
          <div className="absolute inset-[-4.35%]">
            <img alt="" className="block size-full max-w-none" src={img6} />
          </div>
        </div>
        <div className="absolute left-[calc(50%-223px)] top-[619px] size-[28px] -translate-x-1/2" data-name="星形 3">
          <img alt="" className="absolute block size-full max-w-none" src={img7} />
        </div>
      </div>
      <div className="absolute left-[170px] top-[584px] h-[456px] w-[409px]" data-name="lihe">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 top-0 size-full max-w-none" src={imgLihe} />
        </div>
      </div>
      <div className="absolute left-[82px] top-[319px] h-[189px] w-[585px] overflow-clip" data-name="文案">
        ...
        >
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <img alt="" className="absolute left-0 top-0 size-full max-w-none" src={img8} />
          </div>
        </div>
        <div
        ...
        <div className="absolute contents left-[133px] top-[25px]">
          <div className="absolute left-[133px] top-[25px] h-[81px] w-[320px]" data-name="签到赢奖励 1">
            <img
              alt=""
          ...
          <p className="absolute left-[calc(50%+0.5px)] top-[101px] -translate-x-1/2 whitespace-nowrap text-center text-[56.16px] font-semibold leading-[87.184px] text-[#fede9f]">
            1次抽奖机会
          </p>
        </div>
      </div>
